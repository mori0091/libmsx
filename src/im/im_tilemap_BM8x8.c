...
void im_tilemap_BM8x8(const BM8x8 tileset[256], size_t n, const uint8_t tilemap[][2], BM8x8 * dst) {
  ...
  while (n--) {
    const BM8x8 * src = &tileset[*p++];
     switch (*p++) {
      case IM_COPY:
        im_copy_BM8x8(src, dst);
        break;
      case IM_FLIP_HORZ:
        im_hflip_BM8x8(src, dst);
        break;
      case IM_FLIP_VERT:
      ...
      case IM_TRANSPOSE:
        ...
        break;
      case IM_ROTATE_90:
        im_rot90_BM8x8(src, dst);
        break;
      case IM_ROTATE_180:
        im_rot180_BM8x8(src, dst);
        break;
      case IM_ROTATE_270:
        im_rot270_BM8x8(src, dst);
        break;
      case IM_ANTITRANSPOSE:
        im_adtr_BM8x8(src, dst);
        break;
      case IM_COMPLEMENT:
        im_cmpl_BM8x8(src, dst);
        break;
    }
    dst++;
  }
