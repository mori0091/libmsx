...
const uint8_t i_table_00_data[] = {
  0xff,
};
const struct snd_i_table i_table_00 = {
  .wait    = 255,
...
const uint8_t i_table_01_data[] = {
//<-------------------- AD -------------------------->
//                                          <-- S --->
  0x1e, 0x1c, 0x1a, 0x18, 0x16, 0x14, 0x12, 0x10, 0xff,
//<-------------------- R --------------------------->
  0x0e, 0x0c, 0x0a, 0x08, 0x06, 0x04, 0x02, 0x00, 0xff,
};
const struct snd_i_table default_i_tables[] = {
  [0] = {
    .wait    = 1,
    .ad_part = i_table_01_data + 0,
    .s_part  = i_table_01_data + 7,
    .r_part  = i_table_01_data + 9,
  },
};
